...
<html lang="en">
    ...
    <body>
        ...
        <div class="heading">
            Healthy History for {{ $toDownloadPdf->animalclass->className }} with Tag Number <b><u>{{ date('Ymd', strtotime($toDownloadPdf->DoJ)).'-'.$toDownloadPdf->id }}
        </div>
        <table class="table">
            <tr class="trh">
                <th>Date</th>
            ...
            @forelse ($toDownloadPdf->healthyhistories as $healthyhistory)
                <tr>
                    <td>
        ...
        <footer>
            <div>Healthy History for Animal Tag Number <b><u>{{ date('Ymd', strtotime($toDownloadPdf->DoJ)).'-'.$toDownloadPdf->id }}</u></b></div>
