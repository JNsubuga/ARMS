        ...
        <div class="py-4 w-full px-2">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <a href="{{route('product.create')}}" class="bg-blue-600 hover:bg-blue-500 text-white font-semibold py-2 px-4 border border-gray-400 rounded-lg shadow">
                        Register Product
                    </a>
                    <table class="table-auto w-full mt-4">
                        <tr class="text-left border-b-2 border-gray-200 font-bold uppercase">
                            <th class="py-1 px-6">Product</th>
                            <th class="py-1 px-6">Unit Price</th>
                        ...
                        @forelse ($products as $product)
                            <tr class="bg-white border-b dark:bg-gray-100 dark:border-gray-200">
                                ...
                                <td class="flex py-1 px-6">
                                    <a href="{{route('product.edit', $product->id)}}" class="text-blue-600 italic pr-4">Edit</a>
                                    <form action="{{route('product.destroy', $product->id)}}" method="post" onsubmit="return confirm('Are you sure! You need to Delete this Record?!')">
                                        @csrf
                                        @method('DELETE')
