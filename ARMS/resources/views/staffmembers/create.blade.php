    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 pt-4 w-1/3">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form method="POST" action="{{ route('staffmember.store') }}">
                    @csrf
                    <!-- Names -->
                    <div class="md:flex md:items-center mb-2">
                        ...
                        <div class="md:w-2/3 my-0 py-0">
                            <x-input id="Names" class="block mt-1 w-full" type="text" name="Names" :value="old('Names')" autofocus />
                            @error('Names')
                    ...
                    <div class="md:flex md:items-center mb-2">
                        ...
                        <div class="md:w-2/3 my-0 py-0">
                            <x-input id="NoK" class="block mt-1 w-full" type="text" name="NoK" :value="old('NoK')" />
                            @error('NoK')
                                <p class="text-red-500 text-xs italic">{{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="md:flex md:items-center mb-2">
                        ...
                        <div class="md:w-2/3 my-0 py-0">
                            <x-input id="PoB" class="block mt-1 w-full" type="text" name="PoB" :value="old('PoB')" />
                            @error('PoB')
                                <p class="text-red-500 text-xs italic">{{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="md:flex md:items-center mb-2">
                        ...
                        <div class="md:w-2/3 my-0 py-0">
                            <x-input id="Qualification" class="block mt-1 w-full" type="text" name="Qualification" :value="old('Qualification')" />
                            @error('Qualification')
                                <p class="text-red-500 text-xs italic">{{$message}}</p>
                            @enderror
                        </div>
